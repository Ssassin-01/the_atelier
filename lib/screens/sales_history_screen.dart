...
class SalesHistoryScreen extends ConsumerWidget {
      ...
      body: sales.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildDateGroup(context, ref, dateKey, daySales, settings);
              },
            ),
    );
  }
  ...
  Widget _buildDateGroup(
    ...
    WidgetRef ref,
    String dateKey,
    List<BusinessTransaction> daySales,
    ...
    return Column(
      ...
      children: [
        ...
        ...daySales.map((tx) => _buildSaleCard(context, ref, tx, settings)),
        ...
        child: ClipPath(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
              color: Colors.white,
              border: Border(
                left: BorderSide(color: ArtisanalTheme.primary, width: 4),
              ),
            ),
            child: Row(
              children: [
